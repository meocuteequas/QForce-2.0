...
import { X, Calendar, Trash2, Plus, CheckSquare, Square, Edit, Copy, Send } from "lucide-react";
...
import type { Task, Column, Subtask, CustomField } from "../kanban";
...
export default function TaskDetailSidebar({
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: generateId(),
      content: "This task was created. Let's discuss it here.",
      sender: "System",
      timestamp: new Date(),
    },
    {
      id: generateId(),
      content: "Feel free to ask any questions or provide updates.",
      sender: "System",
      timestamp: new Date(),
    },
    {
      id: generateId(),
      content: "You can also add subtasks and custom fields.",
      sender: "System",
      timestamp: new Date(),
    },
    {
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-full sm:w-[800px] bg-white dark:bg-gray-800 shadow-lg border-l dark:border-gray-700 z-50 flex flex-col">
        ...
        <div>
          {isEditingTitle ? (
            ...
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-semibold dark:text-gray-200 mr-4">{editedTask.title}</h3>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div
          className={`sm:flex flex-col flex-1 overflow-hidden border-r dark:border-gray-700`}
        >
        ...
        {/* Chat Section */}
        <div className={`sm:flex flex-col flex-1 overflow-hidden`}>
          <div className="flex-1 overflow-y-auto p-4">
